...
class TestBug2 extends ModelBehaviours {

  describe("Bug2Model of size 3") {
    val correctLogWMC = 23.65805065509298 +- 0.00001
    val model = new Bug2Model(3)
    it should behave like verySmallModel(model, correctLogWMC)
  }

  describe("Bug2Model of size 5") {
    val correctLogWMC = 53.42940228671906 +- 0.00001
    val model = new Bug2Model(5)
    it should behave like smallModel(model, correctLogWMC)
  }

  describe("Bug2Model of size 10") {
    val correctLogWMC = 176.8553938812585 +- 0.00001
    val model = new Bug2Model(10)
