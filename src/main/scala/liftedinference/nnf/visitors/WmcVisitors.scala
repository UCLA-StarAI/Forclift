...
package liftedinference.nnf.visitors

import scala.language.implicitConversions
import liftedinference.inference.DomainSizes
import liftedinference.inference.PredicateWeights
import liftedinference.nnf._
import liftedinference.util.SignLogDouble
import liftedinference.util.Binomial
import liftedinference.inference.WeightedCNF
import liftedinference.PositiveUnitClause
import liftedinference.constraints.Constraints
import liftedinference.propositional.C2DError
import liftedinference.util.LogDouble
import liftedinference.util.SoftMemCache
import liftedinference.Domain
...
protected class LogDoubleWmc extends NnfVisitor[(DomainSizes, PredicateWeights), LogDouble] with WmcVisitor {
  ...
  import liftedinference.util.LogDouble._
...
protected class SignLogDoubleWmc extends NnfVisitor[(DomainSizes, PredicateWeights), SignLogDouble] with WmcVisitor {
  ...
  import liftedinference.util.SignLogDouble._
