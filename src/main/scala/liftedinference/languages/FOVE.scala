...
import liftedinference.Atom
import liftedinference.CNF
import liftedinference.Clause
import liftedinference.Predicate
import liftedinference.VarNameSpace
import liftedinference.compiler.Compiler
import liftedinference.inference.DomainSizes
import liftedinference.inference.PredicateWeights
import liftedinference.inference.PredicateWeights.map2PredicateWeights
import liftedinference.inference.WeightedCNF
import liftedinference.inference.Weights
