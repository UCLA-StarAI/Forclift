...
//domain Person 3 {guy}
//
//predicate p(Person,Person) 1 1
//predicate a(Person) 1 1
//predicate b(Person) 1 1
//predicate c(Person) 1 1
//predicate d(Person) 1 1
//predicate e(Person) 1 1
//predicate f(Person) 1 1
//predicate g(Person) 1 1
//
...
//    model.theory.showNnfPdf(true, Integer.MAX_VALUE, "transitive")
//
